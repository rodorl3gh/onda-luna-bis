...
export default function ProductTable({ data, loading, viewMode, onEdit, onDelete }: ProductTableProps) {
      ...
      {paginated.length === 0 ? (
        ...
        <>
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        <button
                          onClick={() => onDelete(p)}
                          className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium border bg-red-100 text-red-700 border-red-200 hover:bg-red-200 dark:bg-red-500/15 dark:text-red-400 dark:border-red-500/25 dark:hover:bg-red-500/25 transition-colors"
                        >
                          <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          {paginated.map((p) => (
            <div
              key={p.id}
              className="md:hidden rounded-xl border border-[var(--admin-border)] bg-[var(--admin-bg-secondary)] p-4 mb-3"
              style={p.color ? { borderLeftColor: p.color, borderLeftWidth: "4px", borderLeftStyle: "solid" } : undefined}
            >
              ...
              <div className="grid grid-cols-2 gap-1.5">
                ...
                <button onClick={() => onDelete(p)} className="inline-flex items-center gap-1 justify-center py-2 rounded-lg text-xs font-medium border bg-red-100 text-red-700 border-red-200 hover:bg-red-200 dark:bg-red-500/15 dark:text-red-400 dark:border-red-500/25 dark:hover:bg-red-500/25 transition-colors min-h-[40px]">
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                  </svg>
                  <span>Eliminar</span>
            ...
            >
              ...
              <div className="p-3 flex flex-col gap-2 flex-1">
                ...
                <div className="grid grid-cols-2 gap-1 mt-auto pt-2 border-t border-[var(--admin-border)]">
                  ...
                  <button
                    onClick={() => onDelete(p)}
                    className="inline-flex items-center gap-0.5 justify-center py-1.5 rounded-lg text-[10px] font-medium border bg-red-100 text-red-700 border-red-200 hover:bg-red-200 dark:bg-red-500/15 dark:text-red-400 dark:border-red-500/25 dark:hover:bg-red-500/25 transition-colors"
                  >
                    <svg className="w-2.5 h-2.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    </svg>
